...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def _get_obs(self):
        ...
        self.obs_dict = {}
        self.obs_dict["com_angular_pose"] = quat_to_euler(self.sim.data.qpos[3:7])
        self.obs_dict["com_pos"] = self.sim.data.qpos[:3]
        self.obs_dict["joints_pos"] = self.sim.data.qpos[7:].copy()
        self.obs_dict["joints_vel"] = self.sim.data.qvel[-8:].copy()
        self.obs_dict["com_vel_x"] = xvel.copy()
    ...
    def reset_model(self, seed=None):
        ...
        self.reset_pose[3:7] = np.array([1, 0, 0, 0])
        self.reset_vel = (
            self.init_qvel
