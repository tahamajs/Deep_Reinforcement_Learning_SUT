...
def parse_arguments():
    ...
    parser.add_argument(
        "--n", dest="n", type=int, default=100, help="The value of N in N-step A2C."
    )
    parser.add_argument(
        "--reward_norm",
        dest="reward_normalizer",
        type=float,
        default=100.0,
        help="Normalize rewards by.",
    )
    parser.add_argument(
        "--random_seed", dest="random_seed", type=int, default=999, help="Random Seed"
    )
    parser.add_argument(
        "--test_episodes",
        dest="test_episodes",
