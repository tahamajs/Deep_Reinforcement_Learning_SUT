...
def main():
    ...
    policy_pi_sync, value_func_pi_sync, policy_iters_pi_sync, value_iters_pi_sync = (
        policy_iteration_sync(env, gamma)
    )
    print(f"Policy Iters: {policy_iters_pi_sync}, Value Iters: {value_iters_pi_sync}")

    print("\nRunning Policy Iteration (Async Ordered):")
    (
        policy_pi_async_ordered,
        value_func_pi_async_ordered,
        policy_iters_pi_async_ordered,
        value_iters_pi_async_ordered,
    ) = policy_iteration_async_ordered(env, gamma)
    print(
        f"Policy Iters: {policy_iters_pi_async_ordered}, Value Iters: {value_iters_pi_async_ordered}"
    )

    print("\nRunning Policy Iteration (Async Randperm):")
    (
        policy_pi_async_randperm,
        value_func_pi_async_randperm,
        policy_iters_pi_async_randperm,
        value_iters_pi_async_randperm,
    ) = policy_iteration_async_randperm(env, gamma)
    print(
        f"Policy Iters: {policy_iters_pi_async_randperm}, Value Iters: {value_iters_pi_async_randperm}"
    )
    ...
    value_func_vi_async_ordered, iters_vi_async_ordered = value_iteration_async_ordered(
        env, gamma
    )
    print(f"Iters: {iters_vi_async_ordered}")

    print("\nRunning Value Iteration (Async Randperm):")
    value_func_vi_async_randperm, iters_vi_async_randperm = (
