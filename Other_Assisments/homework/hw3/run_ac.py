...
def train_AC(exp_name, env_name, n_iter, gamma, min_timesteps_per_batch,
    ...
    args = {
        'exp_name': exp_name, 'env_name': env_name, 'n_iter': n_iter,
        'gamma': gamma, 'min_timesteps_per_batch': min_timesteps_per_batch,
        'max_path_length': max_path_length, 'learning_rate': learning_rate,
        'num_target_updates': num_target_updates,
        'num_grad_steps_per_target_update': num_grad_steps_per_target_update,
        'animate': animate, 'logdir': logdir, 'normalize_advantages': normalize_advantages,
        'seed': seed, 'n_layers': n_layers, 'size': size
    }
    ...
    agent = ActorCriticAgent(computation_graph_args, sample_trajectory_args, estimate_advantage_args)
    ...
    for e in range(args.n_experiments):
        ...
        def train_func():
            train_AC(
                ...
                animate=args.render,
                logdir=os.path.join(data_path, f'ac_{args.exp_name}_{args.env_name}_{time.strftime("%d-%m-%Y_%H-%M-%S")}_{seed}'),
