...
\section{جمع‌بندی}
پس از اجرای سوئیت، این فایل را با \texttt{latexmk -xelatex report\_fa.tex} کامپایل کنید. برای جمع‌بندی، تفاوت پایداری، کارایی نمونه، ایمنی و مقیاس‌پذیری بین پنج زنجیره را بر اساس جدول‌ها و نمودارهای تولیدی تحلیل کنید.
