...
One paragraph noting briefly relevant references or standard baselines for context (e.g., simple linear regression, small MLPs in coursework).
...
\subsection{Data}
Synthetic datasets are generated as described in `src/data.py`. For regression: $y = X w + \epsilon$ with Gaussian noise $\epsilon\sim\mathcal{N}(0,\sigma^2)$. Include data split details here.
