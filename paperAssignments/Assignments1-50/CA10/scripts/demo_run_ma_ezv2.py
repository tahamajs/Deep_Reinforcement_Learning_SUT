...
def demo(config_path: str = None):
    if config_path is None:
        config_path = os.path.join(os.path.dirname(__file__), "../configs/ma_ezv2_default.yaml")
    ...
    visits, policy_from_visits = mcts.run(policy.net.initial_latent(obs), num_simulations=30, topk=6)
