...
class RecurrentCritic(nn.Module):
    ...
    def forward(self, obs: torch.Tensor, acts: torch.Tensor, h0: Optional[torch.Tensor] = None) -> Tuple[torch.Tensor, torch.Tensor]:
        """
...
class SimpleActor(nn.Module):
    ...
    def __init__(self, obs_dim: int, action_dim: int, hidden_size: int = 128):
        ...
        self.head = nn.Sequential(nn.Linear(hidden_size, hidden_size // 2), nn.ReLU(), nn.Linear(hidden_size // 2, action_dim), nn.Tanh())
