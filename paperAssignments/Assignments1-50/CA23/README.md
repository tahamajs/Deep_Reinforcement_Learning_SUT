...
`REPORT.md` and a longer LaTeX write-up is available as `REPORT.tex` (suitable
for conversion to PDF for submission). These files outline the hypothesis,
method, evaluation metrics, and suggested plots and tables suitable for a
short course-style paper or project report.
