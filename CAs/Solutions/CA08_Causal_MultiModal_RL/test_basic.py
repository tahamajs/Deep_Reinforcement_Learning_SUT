...
def create_test_visualization():
    ...
    try:
        ...
        bars = axes[1, 0].bar(categories, values, color=['skyblue', 'lightgreen', 'lightcoral', 'lightyellow'])
        ...
        plt.tight_layout()
        plt.savefig("visualizations/test_comprehensive_plot.png", dpi=300, bbox_inches='tight')
        plt.close()
