...
class AlgorithmComparator:
    ...
    def statistical_significance_test(self, 
                                    algorithm1: str, 
                                    algorithm2: str,
                                    metric: str = "episode_rewards") -> Dict[str, float]:
    ...
    def plot_comparison(self, 
                       metrics: List[str] = ["episode_rewards", "coordination_scores", "efficiency_scores"],
    ...
    def generate_report(self) -> str:
        ...
        for name, metrics in self.results.items():
            ...
            report += f"  Mean Efficiency: {stats.get('mean_efficiency_score', 0.0):.3f}\n"
...
class PerformanceAnalyzer:
    ...
    def analyze_agent_contribution(self) -> Dict[str, Any]:
        ...
        for agent_id, rewards in self.metrics.agent_rewards.items():
            agent_contributions[agent_id] = {
                ...
                "contribution_to_team": np.mean(rewards) / np.mean(self.metrics.episode_rewards) if self.metrics.episode_rewards else 0.0
            }
    ...
    def compute_sample_efficiency(self, 
                                ...
                                performance_metric: str = "episode_rewards") -> Dict[str, Any]:
        ...
        return {
            ...
            "sample_efficiency": 1.0 / (episodes_to_target + 1e-8) if episodes_to_target else 0.0
        }
