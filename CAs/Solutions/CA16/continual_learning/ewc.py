...
class ElasticWeightConsolidation:
    ...
    def __init__(self, model: nn.Module, lambda_ewc: float = 1000.0, device: str = 'cpu'):
        self.model = model
    ...
    def compute_fisher_information(self, dataloader, task_id: int, num_samples: int = 1000):
    ...
    def compute_ewc_loss(self, task_id: int) -> torch.Tensor:
        ...
        for name, param in self.model.named_parameters():
            if name in self.optimal_params[task_id] and name in self.fisher_information[task_id]:
