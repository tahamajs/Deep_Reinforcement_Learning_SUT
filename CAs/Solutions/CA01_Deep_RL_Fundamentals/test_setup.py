...
def test_imports():
    ...
    try:
        ...
        from environments.custom_envs import SimpleGridWorld, MultiArmedBandit, create_cartpole_env
...
def test_agent_creation():
    ...
    try:
        ...
        # Test DQN agent
        dqn_agent = DQNAgent(state_size=4, action_size=2, use_dueling=True, use_double_dqn=True)
