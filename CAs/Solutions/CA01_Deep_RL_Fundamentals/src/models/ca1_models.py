...
class NoisyLinear(nn.Module):
    def __init__(self, in_features: int, out_features: int, sigm_init: float = 0.017):
        ...
        nn.init.constant_(self.sigma_weight, sigm_init)
        nn.init.constant_(self.sigma_bias, sigm_init)
