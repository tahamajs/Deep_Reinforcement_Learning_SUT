...
def plot_world_model_analysis(world_model, test_data, device, title="World Model Analysis"):
...
def plot_performance_comparison(eval_rewards, random_rewards, title="Performance Comparison"):
    ...
    # Reward distribution
    plt.subplot(2, 2, 2)
    plt.boxplot([eval_rewards, random_rewards], labels=['Dreamer Agent', 'Random Policy'])
